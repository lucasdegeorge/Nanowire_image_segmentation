...
from p2p_4ch_dataloader import *
...
pt_file = "C:/Users/lucas.degeorge/Documents/Images/resized_images/combined_data.pt"
...
class pix2pix_trainer:
    def __init__(self, generator, discriminator, criterions, lr, batch_size, timestamp=None) -> None:
        ...
        self.train_dataloader = get_dataloader(pt_file, batch_size, shuffle=True, pin_memory=True)
